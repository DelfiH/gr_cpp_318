...
void task2() {
    ...
    // Диапазоны значений
    cout << "Диапазоны значений типов данных:" << endl;
    ...
    cout << "long: от " << (numeric_limits<long>::min()) << " до " << numeric_limits<long>::max() << endl;
    cout << "char: от " << static_cast<int>(numeric_limits<char>::min()) << " до " << static_cast<int>(numeric_limits<char>::max()) << endl;
